...
public class UtilProp {
   ...
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\Kyle's Surface\\Documents\\eclipse\\workspace_CSCI4830_0129\\webproject\\WebContent\\WEB-INF\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat7/webapps/webproject/WEB-INF/config.properties";
